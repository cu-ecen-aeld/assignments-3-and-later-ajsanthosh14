...
if [ ! -e ${OUTDIR}/linux-stable/arch/${ARCH}/boot/Image ]; then
    ...
    echo "Configuring: defconfig for virt arm dev board"
...
# check for directory creation failure
if [ ! -d "${OUTDIR}/rootfs" ]
then
	echo "ERROR: rootfs not created!"
	exit 1
fi
...
echo "Cleaning the uilding the writer utility"
cd ${FINDER_APP_DIR}
make clean
...
echo "Copying the finder content to HOME"
